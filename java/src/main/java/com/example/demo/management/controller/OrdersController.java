...
import com.example.demo.management.service.impl.OrdersServiceImpl;
...
public class OrdersController {
    ...
    @ApiOperation("查看货物是否已经生成订单")
    public ApiResponse<Object> checkOrders(
            @RequestBody String goodId
    ) {
        ordersService.checkOrders(goodId);
        return ApiResponse.success();
    }
