...
public class AutoMapper {
    ...
    //设置全局配置
        ...
        gc.setOutputDir(path+"/java/src/main/java");
        //设置生成的类的名称
        ...
        ds.setUrl("jdbc:mysql://8.130.54.10:3306/logisticsPlatform?useUnicode=true&charaterEncoding=utf-8&SSL=true&serverTimezone=Asia/Shanghai");
